...
latex_documents = [
    (master_doc, 'WebLogo.tex', 'WebLogo Documentation',
     'Gavin E. Crooks', 'manual'),
]
...
man_pages = [
    (master_doc, 'weblogo', 'WebLogo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'WebLogo', 'WebLogo Documentation',
     author, 'WebLogo', 'One line description of project.',
     'Miscellaneous'),
]
